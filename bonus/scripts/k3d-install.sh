...
# "Clone Argo CD manifest conf"
#after gitlub k8s setup -->
# sudo git clone http://$ip/root/aerragha-config.git ~/bonus --->  
# sudo kubectl apply -f ~/bonus/argocd_manifest/manifest.yaml -n argocd